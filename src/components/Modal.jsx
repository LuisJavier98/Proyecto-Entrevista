...
const Modal = ({ cancion,setcancion }) => {
  return (
    <>
      {
        cancion ?
          <div className="bg-red-700 flex  justify-center items-center w-full fixed bottom-0 left-0 h-28 transition-all p-7 rounded-t-2xl ">
            <audio  autoPlay className="md:w-3/5 w-full " src={cancion} controls ></audio >
